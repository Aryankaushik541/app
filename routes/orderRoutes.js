...
import {
  ...
  confirmUpiPaymentController,
  createOrderController,
  createUpiPaymentController,
...
router.post("/payments/upi", isAuth, createUpiPaymentController);
router.put("/payments/upi/:id/confirm", isAuth, confirmUpiPaymentController);
